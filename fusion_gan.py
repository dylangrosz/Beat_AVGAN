...
tb_g_id = 0
print_inter = 100
logdir = '/mnt/c/Users/dylan/PycharmProjects/firstone/hybridmusic/save/l2={},w={},e={},clip={}'.format(dis_l2_reg_lambda,
                                                                                       dis_wgan_reg_lambda,
...
def pre_train_epoch(sess, generator, data_loader, tb_write, pre_epochs):
    for epoch in range(pre_epochs):
        print(
        'Pre-Training {} Gen at epoch {}, g_count is {}'.format(generator.domain_name, epoch, generator.g_count))
...
def seqgan(pos_file_a, pos_file_b):
    ...
    with tf.name_scope('pretrain-G-F'):
        ...
        f_train_d(sess, dis_data_loader_f, positive_file_a, positive_file_b, negative_file_f, generator_f,
                  discriminator_f, tb_write, PRE_DIS_EPOCH)
...
if __name__ == '__main__':
    seqgan('./jazz_maj_trans.pk', './folk_maj_trans.pk')